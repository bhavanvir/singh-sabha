            ...
            <div className="flex space-x-4">
              <Link href="https://www.youtube.com/@GurdwaraSinghSabhaVictoria">
                <svg
                  ...
                  className="main-grid-item-icon h-6 w-6 hover:fill-muted-foreground transition-colors"
                >
                  <title>YouTube</title>
          ...
          <div className="flex items-center text-sm text-muted-foreground space-x-2 mt-4 sm:mt-0">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5 mr-1 hover:fill-muted-foreground transition-colors"
              >
                <title>GitHub</title>
